...
output_dir=/data01/tmp/ckpt/ft_${lang}_2a64bs512msl3e2e-5_pt_graphcodebert
...
output_dir=/data01/tmp/results/${lang}/${model_dir}
...
output_dir=/data01/tmp/results/${lang}_concat/${model_dir}
