...
deepspeed train.py --deepspeed config/ds_config.json \
    ...
    --output_dir ckpt/pt_graphcodebert_so_dec_csn_vault_jupyter_hws_2a3096bs128msl10k2e-4 \
    --train_dir ../data/pretrain/ \
    --data_config config/pt_data_config_so_dec_csn_vault_jupyter_hws.json \
    --query_column query \
    --doc_column doc \
    --max_steps 10000 \
    --save_steps 1000 \
