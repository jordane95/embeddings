...
pretrained_model_or_path=../models/unixcoder-base
output_dir=ckpt/ft_csn_${lang}_2a32bs256msl3e2e-5nods_pt_unixcoder
data_config_path=config/ft_data_config_csn_${lang}.yaml

add_instruction=False

# deepspeed finetune_mnkd.py --deepspeed config/ds_config.json \
torchrun --nproc_per_node 2 finetune_mnkd.py \
