...
pretrained_model_or_path=ckpt/pt_graphcodebert_csn_2a3096bs128msl10k2e-4/checkpoint-10000
output_dir=ckpt/ft_csn_${lang}_2a64bs512msl3e2e-5_pt_graphcodebert_csn_2a3096bs128msl10k2e-4
data_config_path=config/ft_data_config_csn_${lang}.yaml

add_instruction=False

deepspeed --master_port 16663 finetune_mnkd.py \
